const {
  ...
  async function main() {
    ...
    //   Deploying PriceManager 0xF230C50115445A402487aeaA78acDd9D4C5b362D "0xF82D30B70405a3af72d10849d0D6E4554F2103F8"      
    const tokens = [
      {
        name: "btc",
    ...
    for (const token of tokens) {
      const price = await priceManager.getLastPrice(token.address)
      console.log("price : ", token.name, ethers.utils.formatUnits(price, 30))
    }
  }
